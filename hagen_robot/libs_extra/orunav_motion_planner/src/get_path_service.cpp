...
public:
		 ...
		 orunav_msgs::GetPath::Response &res)
  {
    ...
    ROS_INFO("[GetPathService] - start server : [%f,%f,%f](%f)", tgt.start.pose.position.x, tgt.start.pose.position.y,tf::getYaw(tgt.start.pose.orientation), tgt.start.steering);
