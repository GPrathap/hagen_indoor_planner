...
KMOVehicleExecutionNode::KMOVehicleExecutionNode(ros::NodeHandle &paramHandle){
    ...
    update_goal_sub_ = nh_.subscribe<nav_msgs::Path>("/plan", 1, &KMOVehicleExecutionNode::process_plan, this);
...
void KMOVehicleExecutionNode::process_plan(const geometry_msgs::PathConstPtr& msg1){
